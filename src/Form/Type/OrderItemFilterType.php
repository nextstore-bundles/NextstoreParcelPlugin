    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('state', ChoiceType::class, [
                ...
                'choices' => [
                    'sylius.ui.new' => OrderItemStates::STATE_NEW,
                    'nextstore_sylius_parcel.ui.confirmed' => OrderItemStates::STATE_CONFIRMED,
                    'sylius.ui.cancelled' => OrderItemStates::STATE_CANCELLED,
                    'nextstore_sylius_parcel.ui.purchased' => OrderItemStates::STATE_PURCHASED,
                    'nextstore_sylius_parcel.ui.arrived_at_foreign_warehouse' => OrderItemStates::STATE_FOREIGN_DELIVERY_COMPLETED,
                ],
            ])
